...
/**Test listener.*/
@Slf4j
public class TestListener implements ITestNGListener,ITestListener,IAnnotationTransformer{
	...
	public void onTestSuccess(ITestResult testResult) {
		log.debug("Test "+ testResult.getName()+" passed after: "+(int) ((testResult.getEndMillis() / 1000) % 60)+" seconds!!");
	}


	@Override
	public void onTestSkipped(ITestResult testResult) {
		log.debug("Test "+ testResult.getName()+" skipped after: "+(int) ((testResult.getEndMillis() / 1000) % 60)+" seconds!!");
	}


	@Override
	public void onTestFailure(ITestResult testResult) {
		log.debug("Test "+ testResult.getName()+" failed after: "+(int) ((testResult.getEndMillis() / 1000) % 60)+" seconds!!");
	}

	@Override
	public void onTestStart(ITestResult result) {
		log.debug("Test "+ result.getName()+" started after: "+(int) ((result.getStartMillis() / 1000) % 60)+" seconds!!");
	}
